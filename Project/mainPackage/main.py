...
def main(imgFiles, pointCloudFiles):
    ...
    for filename in files:
        ...
        vehicleInfo = createVehicleInfo((pointCloudFiles + "\\" + filename), imageInfo, median_cloud)
...
def FillVehics(img, imageInfo, median_cloud):
    clusters = ClusterLidar(img,median_cloud)
...
def ClusterLidar(file, median_cloud):
    ...
    points = remove_matching_points(points, median_cloud)
    print(len(points))
...
def createVehicleInfo(file, imageInfo, median_cloud):
    fillVehics = FillVehics(file, imageInfo, median_cloud)
